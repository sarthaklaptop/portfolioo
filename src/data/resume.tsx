...
export const DATA = {
  ...
  locationLink: "",
  description:
    "Self Taught Full Stack Developer and Engineering Student. Passionate about learning new things, building SaaS products, and teaching others to code.",
  summary:
  ...
  contact: {
    email: "sarthakkpatill97@gmail.com",
    tel: "+91 7066431327",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://dub.sh/sarthak/github",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://dub.sh/linkdin/sarthak",
        icon: Icons.linkedin,
  ...
  work: [
    {
      ...
      description:
        "As a Full Stack Web Developer Intern, I am working on improving our Website. Working with Ts for Backend stuffs. Using React.JS & Next.JS for website aswell. My Tech stack is dynamic in my team and I work on different and intresting stuff here."
    }
  ],
  coursework: [
    {
    ...
    },
    {
      ...
      description: "In-depth full-stack web development course with emphasis on project building and understanding complex codebases"
    },
    {
      ...
      description: "this course equipped me with a strong foundation in Python programming, making it an ideal starting point for those looking to learn and apply Pyton in software development."
    }
  ],
  projects: [
    {
    ...
    },
    {
      ...
      active: true,
      description:
        "The Smart Farmer App connects farmers with experts, providing guidance and convenient car rentals. Streamlining all farming needs in one platform.",
      technologies: [
        "React.js",
        "MongoDb",
        "Tailwind",
    ...
    },
    {
      ...
      active: true,
      description:
        "Your go-to online destination for teachers to showcase and sell courses, and for students to discover and purchase quality education—all in one place.",
      technologies: [
        "react.js",
        "Cloudinary",
        "Razorpay",
